...
public class RoundRectImageView extends ImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currRound = a.hasValue(R.styleable.RoundImageView_radius_dp) ? a.getDimensionPixelSize(R.styleable.RoundImageView_radius_dp, currRound) : currRound;
        a.recycle();
    }
    ...
    public void setCurrRound(int currRound) {
        this.currRound = dp2px(currRound);
    }
}